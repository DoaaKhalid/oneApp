            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="is_provider" class="col-md-4 col-form-label text-md-right">{{ __('Provider') }}</label>

                            <div class="col-md-6">
                                <input type="checkbox" id="is_provider" name="is_provider" value="provider">
                                <label for="is_provider" class="col-md-4 col-form-label text-md-right"> provider</label><br>
                                @error('is_provider')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
